...
##########################################################
# Currently requires an sbol file to be in the same folder
#########################################################
#ns for sbol parsing
ns = {
...
def find_if_prot(xml_file_path, term_list):
...
#
filename = "BBa_M45175.xml"
if(find_if_prot(filename, term_list)):
